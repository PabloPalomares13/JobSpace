    ...
    return (
        ...
        <div class="relative overflow-hidden md:flex w-1/2 i justify-around items-center hidden" style={{ background: 'linear-gradient(180deg, rgba(35,100,115,1) 0%, rgba(87,165,181,1) 50%, rgba(173,204,210,1) 100%)' }}>
            <div>
                ...
                <a href="/register" class="cursor-pointer transition-all bg-[#3b92a3] text-white px-6 py-2 rounded-lg border-[#236473] border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px]
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white">
                ...
                <p class="text-sm font-normal text-gray-600 mb-7">Bienvenido de nuevo</p>
